 ...
 * @text 帮助消息文本
 * @desc 扭蛋窗口的帮助消息。“所需金额”替换为所需金额。
 * @default 抽一次扭蛋需要消耗100金币！
 *
 * @param Button Text
 * @text 命令按钮文本
 * @desc 扭蛋命令的按钮文本。
 ...
 * @text 获取消息文本
 * @desc 接收后的消息。“物品名称”将替换为收到的名称。
 * @default 获得 Item Name!
 *
 ...
 * @param Rank1 Effect
 * @text 等级 1 效果
 * @desc 等级 1 效果的动画编号。如果指定 -1，则不显示动画。
 * @default -1
 * @require 1
 * @type animation
 *
 ...
 * Plugin Command:
 *   Gacha open                 # 打开扭蛋屏幕
 *   Gacha add item 1           # 将物品 #1 添加到扭蛋
 *   Gacha remove item 1        # 从扭蛋中删除物品 #1
 *   Gacha clear                # 清除扭蛋
 *
 *
 * 物品备注：
 *   <gachaImage:image>        # 扭蛋图像文件名。请将图像放在“img/gacha/”文件夹中。
 *   <gachaNumLot:10>          # 指定扭蛋物品的中奖数
 *   <gachaRank:5>             # 物品的等级（1-5）。
 */
